      ...
      >
        <div class="entry-wrap">
          <header class="entry-header">
            <h1 class="entry-title" itemprop="headline">Right-Click to Calendar APP page</h1>
          </header>
          <!-- .entry-header -->
          <div class="entry-content" itemprop="text">
            ...
            <p>
              <g-link to="/right-click-to-calendar-policy">Right-Click to Calendarのプライバシーポリシー</g-link>
            </p>
