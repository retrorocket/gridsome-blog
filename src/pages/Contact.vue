      ...
      >
        <div class="entry-wrap">
          ...
          <div class="entry-content" itemprop="text">
            ...
            <form action="https://getform.io/f/3707c1db-0940-4112-9fc3-c37d38be4fec" method="POST">
              ...
              <textarea name="text" class="feedback-input" placeholder="お問い合わせ内容（必須）" required></textarea>
